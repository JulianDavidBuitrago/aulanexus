// Iconografía SVG de línea (estilo consistente, 24×24)
const P = {
  ...
  dice: '<rect x="3" y="3" width="18" height="18" rx="4"/><circle cx="8.5" cy="8.5" r="1.3" fill="currentColor" stroke="none"/><circle cx="15.5" cy="15.5" r="1.3" fill="currentColor" stroke="none"/><circle cx="12" cy="12" r="1.3" fill="currentColor" stroke="none"/><circle cx="15.5" cy="8.5" r="1.3" fill="currentColor" stroke="none"/><circle cx="8.5" cy="15.5" r="1.3" fill="currentColor" stroke="none"/>',
  ...
  idcard: '<rect x="2" y="5" width="20" height="14" rx="2"/><circle cx="8" cy="11" r="2"/><path d="M14 10h4M14 14h4M5 16c.6-1.3 1.7-2 3-2s2.4.7 3 2"/>',
...
export const LOGO = `<svg class="logo-mark" viewBox="0 0 40 40" aria-hidden="true">
  <defs><linearGradient id="lg-a" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#22d3ee"/><stop offset=".55" stop-color="#8b5cf6"/><stop offset="1" stop-color="#ec4899"/></linearGradient></defs>
  <path d="M20 2.5 35 11v18L20 37.5 5 29V11z" fill="none" stroke="url(#lg-a)" stroke-width="2.4" stroke-linejoin="round"/>
  <path d="M13 26.5 20 12l7 14.5M15.6 21.5h8.8" fill="none" stroke="url(#lg-a)" stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round"/>
  <circle cx="20" cy="12" r="2.3" fill="#22d3ee"/><circle cx="13" cy="26.5" r="2" fill="#8b5cf6"/><circle cx="27" cy="26.5" r="2" fill="#ec4899"/>
</svg>`;
